...
export const reformaSubservices: ReformaSubservice[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Qual telha indicar para casa em Teresina?", a: "Para clima quente e litorâneo indicamos telha cerâmica esmaltada (térmica) ou telha sanduíche com isolamento. Para custo-benefício, fibrocimento com manta térmica." },
    ],
