...
const hubMetaTitle = "Empresa de Instalação de Câmeras e Alarmes em Fortaleza | Chico Resolve";
const hubMetaDescription =
  "Empresa de instalação de câmeras de segurança, alarmes residenciais, comerciais e prediais em Fortaleza. Projeto, NF, garantia e app no celular.";
...
export const Route = createFileRoute("/servicos/seguranca/")({
  head: () => {
    const serviceJsonLd = {
      ...
      "@type": "Service",
      name: "Empresa de Instalação de Câmeras e Alarmes em Fortaleza",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.05] text-balance">
              Instalação de Câmeras e Alarmes em <span className="text-primary">Fortaleza</span>
            </h1>
            <p className="mt-6 text-lg text-muted-foreground max-w-[60ch] leading-relaxed">
              A Chico Resolve é empresa de instalação de câmeras de segurança e alarmes em Fortaleza com projeto técnico, equipamentos de marcas homologadas Anatel (Intelbras, Hikvision, Dahua, JFL), cabeamento estruturado em conduíte, integração ao app do celular e garantia formal. Atendemos residências, prédios e comércios — com instalação de alarme residencial, comercial e predial e CFTV IP Full HD ou 4K integrados no mesmo sistema.
            </p>
          ...
          <div className="lg:col-span-5">
            <img
              src={segurancaHero}
              alt="Empresa de instalação de câmeras de segurança e alarmes em Fortaleza — Chico Resolve, técnico instalando CFTV com projeto"
              width={1280}
              height={960}
              loading="eager"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:sticky lg:top-28 h-fit">
            <div className="rounded-2xl bg-card p-7 border border-border">
              ...
              <p className="text-xs text-muted-foreground mb-5">Visita técnica gratuita em Fortaleza</p>
