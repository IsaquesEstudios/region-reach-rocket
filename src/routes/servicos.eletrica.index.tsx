    ...
    <>
      ...
      <section className="pt-12 sm:pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            <span className="font-mono text-xs text-primary uppercase tracking-widest">EL · Elétrica</span>
      ...
      <section className="py-16 bg-surface" aria-labelledby="especialidades-eletrica">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h2 id="especialidades-eletrica" className="text-3xl sm:text-4xl font-black uppercase italic tracking-tighter mb-3">
      ...
      <section className="py-16" aria-labelledby="eletricistas-certificados">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <p className="font-mono text-xs text-primary uppercase mb-3">Destaque · Eletricistas Certificados</p>
            <h2 id="eletricistas-certificados" className="text-3xl sm:text-4xl font-black uppercase italic tracking-tighter mb-6">
