    ...
    <>
      ...
      <section className="pt-12 sm:pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            <span className="font-mono text-xs text-primary uppercase tracking-widest">HD · Hidráulica</span>
      ...
      <section className="py-16 bg-surface" aria-labelledby="especialidades-hidraulica">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h2 id="especialidades-hidraulica" className="text-3xl sm:text-4xl font-black uppercase italic tracking-tighter mb-3">
      ...
      <section className="py-16" aria-labelledby="bombeiro-hidraulico">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <p className="font-mono text-xs text-primary uppercase mb-3">Destaque · Bombeiro Hidráulico</p>
            <h2 id="bombeiro-hidraulico" className="text-3xl sm:text-4xl font-black uppercase italic tracking-tighter mb-6">
