    ...
    <>
      ...
      <section className="py-16 border-t border-border" aria-label="Outras especialidades em pintura">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight mb-10">Outras especialidades em pintura</h2>
          ...
          <div className="mt-10">
            <Link to="/servicos/pintura" className="inline-block rounded-full bg-primary/10 text-primary px-3 py-1 text-[11px] font-semibold uppercase tracking-widest hover:underline">
